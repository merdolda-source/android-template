...
# Özellikler:
# 1. V64'ün Menü Tipleri (List, Grid, Card, Tile)
# 2. V64'ün İkon Convert Sistemi (Hatasız)
# 3. V70'in Gelişmiş Player Motoru (Header, Origin, Referer, Vol 27 Akıcılık)
# 4. System Repair (Repo ve SDK Fix)
...
# --- 2. İKON İŞLEME (V64 SİSTEMİ - CONVERT) ---
...
# --- 3. SETTINGS.GRADLE (SİSTEM REPAIR) ---
...
# --- 4. APP BUILD.GRADLE (SİSTEM REPAIR) ---
...
# --- 7. MAIN ACTIVITY (V64 MENÜ SİSTEMİ) ---
...
# --- 8. CHANNEL LIST (V70 GELİŞMİŞ PARSER - EXTVLCOPT & JSON HEADERS) ---
    ...
    class Load extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String r) {
            ...
            try {
                ...
                // JSON Parsing (h1Key/Val Desteği)
...
# --- 9. PLAYER (V70 GELİŞMİŞ MOTOR - HEADER + WATERMARK + BUFFER) ---
